...
pub struct Critter {
    ...
    pub Flags: uint,
    pub NameStr: *const ScriptString,
...
fn bindgen_test_layout_Critter() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Critter>())).VisCrMap as *const _ as usize },
        8916usize,
        concat!(
            "Offset of field: ",
            stringify!(Critter),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Critter>())).VisCrSelfMap as *const _ as usize },
        8932usize,
        concat!(
            "Offset of field: ",
            stringify!(Critter),
            "::",
            stringify!(VisCrSelfMap)
        )
    );
    assert_eq!(
...
pub struct CritterCl {
    pub _bindgen_opaque_blob: [u32; 1399usize],
}
#[test]
