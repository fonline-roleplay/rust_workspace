pub mod map {
    ...
    pub trait HexExt {
        ...
        fn get_direction(self, other: Self) -> u8;
    }

    impl HexExt for Hex {
        fn get_distance(self, other: Hex) -> u32 {
            get_distance_hex(self, other, true)
        }
        fn get_direction(self, other: Hex) -> u8 {
            get_direction(self, other, true)
        }
    }
